...
namespace Typescript.Definitions.Tools.Tests
{
    ...
    {
        private static string AddTypeAndGenerateTypeScript<TType>(Action<TsModel> modelAsserts = null)
        {
        ...
        public void CanGenerateNestedGenericPropertiesForCustomTypes()
        {
            ...
            Assert.Contains("NestedCustomClassList: Typescript.Definitions.Tools.Tests.GenericsTests.GenerateSpecifyGenericTypesTestClass[][][][];", typeScript);
        }
        ...
        public void CanHandleGenericArgsInBaseClass()
        {
            ...
            Assert.Contains("interface DerivedGenericClass extends Typescript.Definitions.Tools.Tests.GenericsTests.BaseGeneric<string> {", typeScript);
        }
        ...
        public void GenericParameterTypeIsFullyQualified()
        {
            ...
            Assert.Contains("interface DerivedGenericClassWithArgInDifferentNamespace extends Typescript.Definitions.Tools.Tests.GenericsTests.BaseGeneric<DummyNamespace.Test>", typeScript);
        }
        ...
        public void GeneratesComplicatedNestedGenericProperties()
        {
            ...
            Assert.Contains("GenericsHell: System.Tuple<System.Collections.Generic.KeyValuePair<number, string>, Typescript.Definitions.Tools.Tests.GenericsTests.BaseGeneric<string>, number, System.Collections.Generic.KeyValuePair<number, DummyNamespace.Test>>;", typeScript);
        }
        ...
        public void DeepGenericClassInheritenceTreeIsGeneratedCorrectly()
        {
            ...
            Assert.Contains("interface DerivedGenericTwoLevelsDeep extends Typescript.Definitions.Tools.Tests.GenericsTests.DerivedGenericWithNewTypeArgument<string, DummyNamespace.Test> {", typeScript);
            Assert.Contains("interface DerivedGenericWithNewTypeArgument<TNewType, TType> extends Typescript.Definitions.Tools.Tests.GenericsTests.BaseGeneric<TType> {", typeScript);
        ...
        public void DeepGenericInterfaceInheritenceTreeIsGeneratedCorrectly()
        {
            ...
            Assert.Contains("interface IDerivedGenericTwoLevelsDeep extends Typescript.Definitions.Tools.Tests.GenericsTests.IDerivedGenericWithNewTypeArgument<string, DummyNamespace.Test> {", typeScript);
            Assert.Contains("interface IDerivedGenericWithNewTypeArgument<TNewType, TType> extends Typescript.Definitions.Tools.Tests.GenericsTests.IBaseGeneric<TType> {", typeScript);
            Assert.Contains("NewGenericProperty: TNewType;", typeScript);
        }
        ...
        public void DerivedClassWithNewNameForGenericParameter()
        {
            ...
            Assert.Contains("DerivedClassWithNameGenericParameterName<TNewParam, TSomethingNew> extends Typescript.Definitions.Tools.Tests.GenericsTests.BaseGeneric<TSomethingNew>", typescript);
