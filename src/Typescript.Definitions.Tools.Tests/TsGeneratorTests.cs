...
namespace Typescript.Definitions.Tools.Tests
{
    public class TsGeneratorTests
    {
        ...
        public void WhenClassIsIgnored_InterfaceForClassIsntGenerated()
        {
            ...
            model.Classes.Single(o => o.Name == "Address").IsIgnored = true;
        ...
        public void WhenClassIsReferenced_FullyQualifiedNameIsUsed()
        {
            ...
            Assert.Contains("PrimaryAddress: Typescript.Definitions.Tools.Tests.TestModels.Address", script);
            Assert.Contains("Addresses: Typescript.Definitions.Tools.Tests.TestModels.Address[]", script);
        }
        ...
        public void WhenClassWithEnumReferenced_FullyQualifiedNameIsUsed()
        {
            ...
            Assert.Contains("Type: Typescript.Definitions.Tools.Tests.TestModels.ItemType", script);
        }
        ...
        public void WhenConvertorIsRegistered_ConvertedTypeNameIsUsed()
        {
            ...
            var target = new TsGenerator();
            target.Options.TypeConverters.RegisterTypeConverter<string>(type => "KnockoutObservable<string>");
            var script = target.Generate(model);
        ...
        public void WhenConvertorIsRegisteredForGuid_ConvertedTypeNameIsUsed()
        {
            ...
            var target = new TsGenerator();
            target.Options.TypeConverters.RegisterTypeConverter<Guid>(type => "string");
            var script = target.Generate(model);
